  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-12 md:py-20">
        ...
        <div
          className="mx-auto mb-10 max-w-sm transition-all duration-700 delay-500"
          style={{
            opacity: mounted ? 1 : 0,
        ...
        {/* ─── Savings ─── */}
        <div
          className="text-center mb-10 transition-all duration-700 delay-700"
          style={{
            opacity: mounted ? 1 : 0,
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Dashboard */}
            <a
              href="https://agentforja.com/dashboard"
        ...
        {/* ─── Footer ─── */}
        <div
          className="text-center text-slate-600 text-xs space-y-2 transition-all duration-700 delay-700"
          style={{
            opacity: mounted ? 1 : 0,
          }}
        >
