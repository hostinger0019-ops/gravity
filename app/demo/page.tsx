...
export default function DemoPage() {
    ...
    async function sendMessage(text?: string, isAuto = false) {
        ...
        try {
            ...
            const res = await fetch(`/api/bots/${encodeURIComponent(DEMO_SLUG)}/chat`, {
                method: "POST",
            ...
            setMessages((prev) => [
                ...prev,
                { role: "assistant", content: "⚠️ Couldn't connect to the AI. Please try again later." },
            ]);
        } finally {
            setLoading(false);
            setStreaming(false);
                        ...
                        <div className="border-t border-white/5 bg-zinc-950/90 backdrop-blur pb-[env(safe-area-inset-bottom)]">
                            <div className="max-w-3xl mx-auto px-6 py-4">
                                ...
                                <p className="text-center text-zinc-600 text-[10px] mt-3">
                                    ...
                                    <a href="/lifetimedeal#pricing" className="text-violet-500 hover:text-violet-400">
